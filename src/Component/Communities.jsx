                    ...
                    <div className="bg-[#F4FDFF]/90 rounded-xl p-4 md:p-8 shadow-lg mb-6 md:mb-8">
                      ...
                      <div className="relative mb-6 md:mb-8">
                        ...
                        <input
                            ...
                            className="w-full p-3 md:p-4 pl-14 rounded-lg border-2 border-[#97C7F1] text-[#1D1D20] focus:outline-none focus:ring-2 focus:ring-[#1D6EF1] focus:border-transparent text-sm md:text-base"
                            value={searchQuery}
                                    ...
                                    {community.name.charAt(0).toUpperCase()}
                                        ...
                                        {community.likes || 0}
                                              ...
                                              <div className="flex gap-2">
                                                <button
                                                    className="bg-[#1D6EF1] text-white px-3 py-1 md:px-4 md:py-2 rounded-xl hover:bg-[#97C7F1] transition-colors text-sm md:text-base"
                                                ...
                                                <button
                                                    className="bg-[#48BB78] hover:bg-[#48BB78]/90 text-white py-1 px-3 rounded-xl flex items-center"
