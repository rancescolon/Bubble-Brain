...
const Messaging = () => {
  ...
  useEffect(() => {
    const handleConnect = () => {
      ...
      socket.emit("/chat/join-room", {
        ...
        toUserID: parseInt(sessionStorage.getItem("toUserID")),
        roomID: roomID
      });
    };
  ...
  useEffect(() => {
    ...
    const loadChatHistory = async () => {
      // Initialize empty messages array since we're not loading history
      setMessages([]);
    };
  ...
  const handleSendMessage = async (e) => {
    ...
    const messageData = {
      ...
      toUserID: parseInt(otherUserData.id),
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="flex items-center">
              ...
              <div>
                <h2 className="text-xl font-bold">
                  {otherUserData.attributes?.name || otherUserData.email || "Chat"}
                </h2>
          ...
          <div className="bg-[#F4FDFF] h-[60vh] overflow-y-auto p-4">
            <div className="space-y-4">
              {messages.map((msg) => {
                const isOwnMessage = msg.fromUserID === parseInt(userData.id);
                return (
                  <div
                    key={msg.id}
