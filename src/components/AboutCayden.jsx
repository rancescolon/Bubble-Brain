...
import profilePic from '../assets/caydenla.jpg';
      ...
      <div className="p-4">
        ...
        <div className="bg-white rounded-lg p-6 text-black">
          <div className="flex items-center gap-4">
            ...
            />
            <div>
              <h2 className="text-xl font-bold">Cayden La Bara</h2>
              <p className="text-gray-600">
              "Hi, I'm Cayden and I'm a senior that is about to graduate this spring with a Computer Science Degree, I hope to make a lot of money and the future with this degree, and I know how to play the acoustic guitar."
              </p>
            </div>
          </div>
        </div>
